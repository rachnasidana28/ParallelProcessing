...
// Assignment:    Program 3 - Part 4
// Description:   This program applies MPI  and OpenMp directives to the Floyd Warshall Algorithm and 
 ...
 * Purpose:   initialize the adjacency matrix on process 0 and scatter it using a 
...
/*---------------------------------------------------------------------
Function:  Owner
Purpose:   Return rank of process that contains row k
----------------------------------------------------------------------- */
int Owner(int k, int p, int n) {
   return (((p)*((k)+1)-1))/(n);
}  
